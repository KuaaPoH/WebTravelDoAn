...
namespace WebTravel.Areas.Admin.Controllers
{
    ...
    public class BlogsController : Controller
    {
        ...
        public BlogsController(TravelContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BlogId,Title,Alias,CategoryId,Description,Detail,Image,SeoTitle,SeoDescription,SeoKeywords,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,AccountId,IsActive,DayCreated,MonthCreated")] TbBlog tbBlog)
        {
            if (ModelState.IsValid)
            {
                tbBlog.Alias = WebTravel.Utilities.Function.TitleSlugGenerationAlias(tbBlog.Title);
                _context.Add(tbBlog);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["AccountId"] = new SelectList(_context.TbAccounts, "AccountId", "Username", tbBlog.AccountId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BlogId,Title,Alias,CategoryId,Description,Detail,Image,SeoTitle,SeoDescription,SeoKeywords,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,AccountId,IsActive,DayCreated,MonthCreated")] TbBlog tbBlog)
        {
            if (id != tbBlog.BlogId)
            {
                return NotFound();
