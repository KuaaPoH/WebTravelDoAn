...
public partial class TravelContext : DbContext
{
    ...
    public virtual DbSet<TbTourCategory> TbTourCategories { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TbOrderDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Tour).WithMany(p => p.TbOrderDetails)
        ...
        {
            entity.HasKey(e => e.TourId).HasName("PK_tb_Product");
            ...
            entity.HasOne(d => d.CategoryTour).WithMany(p => p.TbTours)
                .HasForeignKey(d => d.CategoryTourId)
                .HasConstraintName("FK_tb_Product_tb_ProductCategory");
        });

        modelBuilder.Entity<TbTourCategory>(entity =>
        {
            entity.HasKey(e => e.CategoryTourId).HasName("PK_tb_ProductCategory");

            entity.ToTable("tb_TourCategory");
        ...
        modelBuilder.Entity<TbTourReview>(entity =>
        {
            entity.HasKey(e => e.ProductReviewId).HasName("PK_tb_ProductReview");

            entity.ToTable("tb_TourReview");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.TbTourReviews)
